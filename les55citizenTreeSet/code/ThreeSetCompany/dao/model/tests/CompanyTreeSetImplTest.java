package ThreeSetCompany.dao.model.tests;

import ThreeSetCompany.dao.Company;
import ThreeSetCompany.dao.CompanyTreeSetImpl;
import ThreeSetCompany.dao.model.*;
...
class CompanyTreeSetImplTest {
 ...
 /*   Comparator<Employee> comparator=new Comparator<Employee>() {
    ...
    @BeforeEach
    void setUp() {
        company = new CompanyTreeSetImpl(5);
        e = new Employee[4];
