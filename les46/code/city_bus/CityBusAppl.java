...
public class CityBusAppl {
    public static void main(String[] args) {
       ...
       // - создать список городских маршрутов на основе автобусов из городского автопарка;
        ...
        // добавили в список
        cityBus.add(bus);// добавили в состав листа
        ...
        System.out.println("Печать списка"); // для все b типа bus из списка cityBus делать
        for (Bus b:cityBus) {
            System.out.println(b);
        }
        //сортировка
     cityBus.sort(Bus::compareTo);// произошла сортировка в памяти компютера
        // печатаем
        ...
        // cчитаем общую вместимость
        int totalCapacity=0;
        for (Bus b:
             cityBus) {
            totalCapacity+=b.getBusCapacity();
        }
        System.out.println("Total capacity " + totalCapacity); // берем методы от элемента списка b
        ...
        System.out.println("====Sorter list By Capacity =========");
