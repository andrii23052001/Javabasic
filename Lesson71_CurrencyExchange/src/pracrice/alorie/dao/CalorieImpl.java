...
public class CalorieImpl implements Calorie {
    ...
    public List<Product> readProductsFromCSV() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("Lesson71_CurrencyExchange/src/pracrice/alorie/Product.csv"))) {
            String line;
    ...
    public void saveFood(List <Product> products) {
        String filePath = "Lesson71_CurrencyExchange/src/pracrice/alorie/saved_food.txt";
    ...
    public List<Product> loadFood() {
        ...
        String filePath = "Lesson71_CurrencyExchange/src/pracrice/alorie/saved_food.txt"; // Укажите полный путь к файлу
