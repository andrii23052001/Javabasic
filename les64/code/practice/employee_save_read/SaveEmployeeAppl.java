...
public class SaveEmployeeAppl {
    public static void main(String[] args) {
        ...
        Address address2= new Address("Berlin","Hans",13,1);
        Employee e1 = new Employee(1,"Peter", LocalDate.of(1996,05,20),2500,address1);
        Employee e2 = new Employee(2,"Yan", LocalDate.of(1990,01,1),2600,address2);

        Set<Employee>employees=new HashSet<>();
        employees.add(e1);
        employees.add(e2);
        //делам новый обьект из класса ObjectOutputStream
