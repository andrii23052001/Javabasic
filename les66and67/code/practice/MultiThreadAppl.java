...
//        task.run(); // это запуск второго thread
        ...
        MyTaskImplements task1 = new MyTaskImplements("Parallel task", MAX); // создали задачу
        ...
        Thread thread2 = new Thread(task2);//создали еще один параллельный поток и передали задачу

        thread1.start();
        thread2.start();
        //создаем массив параллельных задач на класс Implements Runnable
